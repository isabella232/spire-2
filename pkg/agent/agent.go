...
func (a *Agent) Run(ctx context.Context) error {
	...
	if a.c.AdminBindAddress != nil {
		...
		adminEndpoints := a.newAdminEndpoints(manager, attestor, a.c.AuthorizedUsersPrivilegedApi)
...
func (a *Agent) newAdminEndpoints(mgr manager.Manager, attestor attestor.Attestor, authorizedUsersPrivilegedApi []string) admin_api.Server {
	config := &admin_api.Config{
		...
		Attestor:                     attestor,
		AuthorizedUsersPrivilegedApi: authorizedUsersPrivilegedApi,
	}
